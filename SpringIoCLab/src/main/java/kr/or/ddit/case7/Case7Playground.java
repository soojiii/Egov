...
/**
 * Case1Context 와 Case2Context, Case4Context 를 계층 구조로 묶기위한 컨텍스트.
...
public class Case7Playground {
	public static void main(String[] args) {
		...
		ConfigurableApplicationContext child1 =
				new ClassPathXmlApplicationContext(new String[] {"kr/or/ddit/case2/conf/Case2-Context.xml"}, parent);
		
		ConfigurableApplicationContext child2 =
				new ClassPathXmlApplicationContext(new String[] {"kr/or/ddit/case4/conf/Case4-Context.xml"}, parent);
