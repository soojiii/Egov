 ...
 * 			- contructor injection(required) : constructor-arg, c prefix
 * 			- setter injection(optional) : property, p perfix
...
//	log.info("t003 : {}", t003);
//	log.info("service1과 service2 동일객체? : {}", service1 == service2);
//	log.info("service2과 service3 동일객체? : {}", service2 == service3);
//	
