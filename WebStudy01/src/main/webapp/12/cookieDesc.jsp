...
<pre>
	...
	** 쿠키 사용 방법
	...
	<%-- firstName cookie value : <%=findedValue %> --%>
	
	<a href="cookieView.jsp">동일경로에서 확인</a>
	<a href="../11/cookieView.jsp">다른경로에서 확인</a>
	...
	** 쿠키 속성의 종류
	...
	3. domain/host : 쿠키의 재전송 여부를 결정하는 조건.
				...
				ex) cookie's domain : .naver.com, naver.com의 모든 호스트 서버로 재전송되는 쿠키 설정.
