...
1. 헤더 기반의 인증
	...
	응답 으로 401상태코드와 www-authenticate:authType[BASIC:BAERER] 헤더를 전송함.
	브라우저가 응답을 받고, 인증 정보를 엽력받을 수 있는  UI를 선택함.
	인증된 후, 인증상태 정보 유지에 (authorization:authTye[BASIC:BAERER] base64인코딩사용자정보) 헤더를 사용함.                                    
