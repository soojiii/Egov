...
/**
 * 서블릿
 * : 웹상의 요청(HTTP)을 받고(분석), 웹을 통해 응답(HTTP)을 전송(동적자원생성)할 수 있는 객체의 필요요건 
 *		--> HttpServlet
 * 
 * 개발단계
 ...
 * 		servlet container
 * 		jsp container
 * 		UI container : <div><button>버튼</button><span>SPAN</span></div>
 ...
 * 		case 1 : "/" - 정적 자원에 대한 매핑(DefaultServlet의 매핑 정보로 사용된).
 * 		case 2 : "/*", "/member/*" - 경로 매핑
 * 		case 3 : "*.do" - 확장자 매핑
